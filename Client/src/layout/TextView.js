 ...
 { datas?.Time ? datas?.Time?.split(" ")[0] + " வரை) " : ""} 
                    {datas?.Pakshe && (datas?.Pakshe?.split("/")[1]?.split(" ")[1])} &nbsp;
                          ...
                          " பின்னர் க்ருஷ்ண ":" பின்னர் சுக்ல ") : " பின்னர் "}
                           {` ${ datas?.NextTithi?.split("/")[1]?.split(" ")[1]}`}&nbsp;<br />  <br />
